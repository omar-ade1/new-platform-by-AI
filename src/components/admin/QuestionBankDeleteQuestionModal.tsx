...
import type { Question } from "@/components/admin/QuestionBankManager";

export default function QuestionBankDeleteQuestionModal({
  target,
  deleting,
  onConfirm,
  onClose,
        ...
        >
          ...
          >
            ...
            <p className="text-ink/60 text-base mb-1">
              هل تريد حذف السؤال: <span className="font-bold text-ink">&quot;{target.question_text}&quot;</span>؟
            </p>
            <p className="text-ink/40 text-sm mb-7">هيتشال من أي اختبار مربوط بيه كمان.</p>
